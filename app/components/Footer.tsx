        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Cultivating high-performance teams through expert learning.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Accredian</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/why-accredian" className="text-gray-400 hover:text-white transition">
                  Why Accredian
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2 text-gray-400">
              <p>
                Email: <a href="mailto:enterprise@accredian.com" className="hover:text-white transition">enterprise@accredian.com</a>
              </p>
              <p>
